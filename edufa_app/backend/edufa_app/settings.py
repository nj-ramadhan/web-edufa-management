"""
Django settings for edufa_app project.
...
SECRET_KEY = 'django-insecure-^k)tff4&sdia0*_kg)yg*%tb)^e7h8vvs06)awidz57ud2&^3f'
...
if DEBUG:
    ...
    ALLOWED_HOSTS = [
        '82.29.162.244',
        'edufa-management.com',
        'www.edufa-management.com'
        ]
    
    CSRF_TRUSTED_ORIGINS = [
        'http://localhost:3000',
        'https://localhost:3000',
        'http://edufa-management.com', 
        'https://edufa-management.com', 
        'http://www.edufa-management.com',
        'https://www.edufa-management.com'
        ]
...
WSGI_APPLICATION = 'edufa_app.wsgi.application'
